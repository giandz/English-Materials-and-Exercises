...
var the_class = {
	"title": "How old are you? I'm 25",
	"language": "en",
	"level": "a1",
	"course": "esl",
	"type": "systems",
	"targetlanguage": "Numbers from 1 to 100. Asking and talking about age.",
	"subtype": "vocabulary/functions",
	"number": 2,
	"stages": {
		"stage1": {
			"title": "Lead-In",
			"entries": {
				...
				"entry2":{
					"type": "picture",
					"source": "unsplash.com",
					"url": "https://images.unsplash.com/photo-1551892644-51a6e2e8fc65?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=340&q=80",
					"teacher":""
				},				
				"entry3":{
					"type": "instruction",
		...
		"stage2": {
			...
			"entries": {
				...
				"entry2": {
					"type": "conversation",
					"pic": "https://images.pexels.com/photos/1059111/pexels-photo-1059111.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940",
					"audio": "",
					"source": "",
					"characters": [{
							"name": "separator"
